...
<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        ...
        <form method="POST" action="<?php echo e(url('/supplierlist')); ?>">
...
<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        ...
        <form method="POST" action="<?php echo e(url('/supplierlist/update')); ?>">
            <?php echo e(csrf_field()); ?>
    ...
    <div class="ibox">
            ...
            <div class="ibox-body">
                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                                <?php $__currentLoopData = $supplierdetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $suplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <th><?php echo e($suplier->id); ?></th>
                                    <th><?php echo e($suplier->supplier_cat); ?></th>
                                    <th><?php echo e($suplier->supplier_name); ?></th>
                                    <td><?php echo e($suplier->supplier_mobile); ?></td>
                                    <td><?php echo e($suplier->supplier_email); ?></td>
                                    
                                    <td><?php echo e($suplier->sopaning_balance); ?></td>
                                    ...
                                    <td>
                                            ...
                                            <button onclick='edit(<?php echo e($suplier->id); ?>)' data-toggle="modal" id="edit" data-target="#edit" class="btn btn-success" ><span class="fa fa-pencil font-14"></span></button>   
                                       
                                        <a href="<?php echo e(url('/supplier/delete/'.$suplier->id)); ?>" class="btn btn-danger" title="Delete"onclick="return confirm('Are you sure to delete this?'); ">
...
<script>
        function edit(id) {
                ...
                $.ajax({
                    type:'GET',
                    url:"<?php echo e(url('/supplier-info')); ?>/"+x,
