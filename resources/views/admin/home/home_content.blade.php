                            ...
                            <div class="ibox-body">
                                ...
                                <table class="table table-striped m-t-20 visitors-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{asset('public/admin/')}}/asset/img/flags/us.png" />USA</td>
                                            <td>755</td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{asset('public/admin/')}}/asset/img/flags/Canada.png" />Canada</td>
                                            <td>700</td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{asset('public/admin/')}}/asset/img/flags/India.png" />India</td>
                                            <td>410</td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{asset('public/admin/')}}/asset/img/flags/Australia.png" />Australia</td>
                                            <td>304</td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{asset('public/admin/')}}/asset/img/flags/Singapore.png" />Singapore</td>
                                            <td>203</td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{asset('public/admin/')}}/asset/img/flags/uk.png" />UK</td>
                                            <td>202</td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{asset('public/admin/')}}/asset/img/flags/UAE.png" />UAE</td>
                                            <td>180</td>
                                            <td>
                                                <div class="progress">
                                ...
                                <ul class="media-list media-list-divider m-0">
                                    <li class="media">
                                        <a class="media-img" href="javascript:;">
                                            <img class="img-circle" src="{{asset('public/admin/')}}/asset/img/users/u1.jpg" width="40" />
                                        </a>
                                    ...
                                    <li class="media">
                                        <a class="media-img" href="javascript:;">
                                            <img class="img-circle" src="{{asset('public/admin/')}}/asset/img/users/u2.jpg" width="40" />
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <a class="media-img" href="javascript:;">
                                            <img class="img-circle" src="{{asset('public/admin/')}}/asset/img/users/u3.jpg" width="40" />
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <a class="media-img" href="javascript:;">
                                            <img class="img-circle" src="{{asset('public/admin/')}}/asset/img/users/u6.jpg" width="40" />
                                        </a>
                                        <div class="media-body">
                        ...
                        <div class="ibox">
                            ...
                            <div class="ibox-body">
                                <ul class="media-list media-list-divider m-0">
                                    <li class="media">
                                        <a class="media-img" href="javascript:;">
                                            <img src="{{asset('public/admin/')}}/asset/img/image.jpg" width="50px;" />
                                        </a>
                                        <div class="media-body">
                ...
                <div>
                    <a class="adminca-banner" href="http://admincast.com/adminca/" target="_blank">
                        ...
                        <div class="wrap-1">
                            <div class="wrap-2">
                                <div>
                                    <img src="{{asset('public/admin/')}}/asset/img/adminca-banner/adminca-preview.jpg" style="height:160px;margin-top:50px;" />
                                </div>
                            ...
                            <div style="flex:1;">
                                <div class="d-flex justify-content-end wrap-3">
                                    <div class="adminca-banner-b m-r-20">
                                        <img src="{{asset('public/admin/')}}/asset/img/adminca-banner/bootstrap.png" style="width:40px;margin-right:10px;" />Bootstrap v4</div>
                                    <div class="adminca-banner-b m-r-10">
                                        <img src="{{asset('public/admin/')}}/asset/img/adminca-banner/angular.png" style="width:35px;margin-right:10px;" />Angular v5+</div>
                                </div>
                                <div class="dev-img">
                                    <img src="{{asset('public/admin/')}}/asset/img/adminca-banner/sprite.png" />
                                </div>
                            </div>
                        </div>
                    </a>
